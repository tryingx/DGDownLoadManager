...
+(NSMutableArray *)getAllFinishFilesListWithPatharr:(NSArray *)patharr {
    ...
    for (NSString *pathstr in patharr) {
        ...
        {
            GFileModel *finishedFile=[[GFileModel alloc] init];
            ...
            finishedFile.fileSize=[GCommonHelper getFileSizeString:[NSString stringWithFormat:@"%d",length]];
